<template>
  <div>
    <VueHeader catchtext="お探しのページは見つかりません"></VueHeader>
...
export default class Vue0015 extends Vue {

  public created(): void {
    console.log('Vue0015.created!!');
    HeadTagUtility.setInfo(
      'お探しのページは見つかりません',
      '保活ナビ,お探しのページは見つかりません,エラーページ',
      'お探しのページは見つかりません'
    );
  }

  public mounted(): void {
    console.log('Vue0015.mounted!!');
    document.title = 'Vue0015';
  }

  public beforeRouteEnter(to: any, from: any, next: any): void {
    console.log('Vue0015.beforeRouteEnter!!', to, from, next);
  ...
  public beforeRouteUpdate(to: any, from: any, next: any): void {
    console.log('Vue0015.beforeRouteUpdate!!', to, from, next);
  ...
  public beforeRouteLeave(to: any, from: any, next: any): void {
    console.log('Vue0015.beforeRouteLeave!!', to, from, next);

<template>
  <div>
    <VueHeader catchtext="東京都杉並区【認証保育園】の保育園探しを、保育園探しナビがサポートします。"></VueHeader>
...
import NearNursery from "./_partial/NearNursery.vue";
...
export default class Vue0007 extends Vue {

  public created(): void {
    console.log('Vue0007.created!!');
  ...
  public mounted(): void {
    console.log('Vue0007.mounted!!');
    document.title = 'Vue0007';
  }

  public beforeRouteEnter(to: any, from: any, next: any): void {
    console.log('Vue0007.beforeRouteEnter!!', to, from, next);
  ...
  public beforeRouteUpdate(to: any, from: any, next: any): void {
    console.log('Vue0007.beforeRouteUpdate!!', to, from, next);
  ...
  public beforeRouteLeave(to: any, from: any, next: any): void {
    console.log('Vue0007.beforeRouteLeave!!', to, from, next);

                ...
                <div class="three column row">
                    <div class="column">
                        <label class="bns-form-button--primary">
                            <input type="checkbox" name="checkbox01" class="bns-form-button--primary__check"
                                   data-bns-checkbox="check">
                            <span class="bns-form-button--primary__text">許可</span>
                        </label>
                    </div>
                    <div class="column">
                        <label class="bns-form-button--secondary">
                            <input type="checkbox" name="checkbox02" class="bns-form-button--secondary__check"
                                   data-bns-checkbox="check">
                    ...
                    <div class="column">
                        <label class="bns-form-button--third">
                            <input type="checkbox" name="checkbox03" class="bns-form-button--third__check"
                                   data-bns-checkbox="check">
                ...
                <div class="three column row">
                    <div class="column">
                        <label class="bns-form-button">
                            <input type="checkbox" name="checkbox04" class="bns-form-button__check"
                                   data-bns-checkbox="check">
                    ...
                    <div class="column">
                        <label class="bns-form-button">
                            <input type="checkbox" name="checkbox05" class="bns-form-button__check"
                                   data-bns-checkbox="check">
                    ...
                    <div class="column">
                        <label class="bns-form-button">
                            <input type="checkbox" name="checkbox06" class="bns-form-button__check"
                                   data-bns-checkbox="check">
        ...
        <div class="bns-modal-footer">
            <div class="bns-layout--default-no-margin">
                <p class="bns-text--left">
                    <a href="javascript: void(0);" class="bns-text-link--area" data-bns-modal="close"><i
                                class="bns-icon-carret"></i>戻る</a>
                </p>
                <p class="bns-text--right">
                    <label>
                        <input type="checkbox" name="all-release" class="bns-form-select__check"
                               data-bns-checkbox="release-trigger">
...
@if(Request::is('NON0005'))
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBoiCtV1U4l_E7Ni3vCaowkZHgToieX_Co" async
            defer></script>
@endif

...
<body>
  ...
  <table>
    <thead>
      <tr>
        ...
        <th>URL</th>
        <th style="width:6.0em;">GRI最終更新日</th>
        <th style="width:6.0em;">デザインFIX状況</th>
        <th style="width:6.0em;">CQ最終更新日</th>
    ...
    <tbody>
      ...
      <tr>
        <td>NON0009_2</td>
        <td>保育園検索</td>
        <td><a href="{{ url('/NON0009_2') }}" target="_blank">NON0009_2</a></td>
        <td>8/21 21:09</td>
        <td>90%</td>
        <td>-</td>
        <td>保育園選びのポイント</td>
      ...
      <tr>
        <td>NON0009_3</td>
        <td>保育園検索</td>
        <td><a href="{{ url('/NON0009_3') }}" target="_blank">NON0009_3</a></td>
        <td>8/21 21:09</td>
        <td>50%</td>
        <td>-</td>
        <td>保育園選びのポイント</td>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td>facility-carousel</td>
        <td>カルーセル</td>
        <td><a href="{{ url('/partial/facility-carousel') }}" target="_blank">facility-carousel</a></td>
        <td>8/9</td>
        <td>100%</td>
        <td>-</td>
        <td>施設詳細カルーセル</td>
